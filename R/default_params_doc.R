...
#' @param rng_stream_index A single numeric to be used as position within a
#'   single RNG stream, as generated by [set_seed()]. See [set_seed()]
#'   documentation for details on how RNGs are handled within [DAISIEutils].
